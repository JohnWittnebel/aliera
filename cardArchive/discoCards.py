...
sys.path.insert(0, '..')
"""
#TODO: what we have to implement before we start:
-selecting 2 card targets from hand (argent, lumi)
-effect to activate when card is discarded from hand (songstress, noir)
-passive effect to activate when another card is discarded from hand (lumi)
-LWs probably need to be put into a queue
"""
##### TOKENS
